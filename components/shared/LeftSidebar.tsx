...
const LeftSidebar = () => {
  ...
  return (
    <section
      className='custom-scrollbar background-light900_dark200 light-border sticky left-0
      top-0 flex h-screen w-fit flex-col justify-between overflow-y-auto border-r p-6 pt-36
    ...
    >
      <section className='flex h-full flex-1 flex-col gap-6'>
        {sidebarLinks.map((item) => {
          ...
          // TODO: Add specific routing for profile page
